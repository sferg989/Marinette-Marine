...
define(function(){
    ...
    var excelExport = function (excelExportCallBack) {
        var step        = {};
    ...
    var excelExportCharts = function (excelExportCallBack) {
        var step        = {};
        step.control = "excel_export_line"
        workers     = new Worker("lib/workers/excel_export.js");
        workers.onmessage = workerDone;
        workers.postMessage(step);
        function workerDone(e) {
    ...
    return {
        ...
        excelExportCharts: excelExportCharts
    };
})/**
