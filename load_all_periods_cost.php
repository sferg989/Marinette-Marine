...
//$ship_code_array[] = 465;
//$ship_code_array[] = 467;
//$ship_code_array[] = "0469";

$ship_code_array[] = "0471";
$ship_code_array[] = "0473";
$ship_code_array[] = "0475";
$ship_code_array[] = "0477";
$ship_code_array[] = "0479";
$ship_code_array[] = "0481";
$ship_code_array[] = "0483";
$ship_code_array[] = "0485";
...
foreach ($ship_code_array as $ship_code){
    $rpt_period_array = getRPTFORSHIPCODE($ship_code);
    foreach ($rpt_period_array as $key=>$value){

        insertCobraCostData($ship_code, $schema, $value,$key);
    }
}
